...
/* =====================================================================
   ...
   1) Health Strip: Pelanggan Aktif (+tren vs bulan lalu), Non-Aktif %,
      Utilisasi Port Global, + pintasan ke Dashboard Finance (BUKAN
      menghitung ulang pendapatan sendiri — supaya angkanya SELALU
      sama dengan Dashboard Finance yang asli, tidak ada 2 versi
   ...
   CATATAN AUDIT (revisi): versi sebelumnya sempat menghitung sendiri
   "Pendapatan Bulan Ini" dari fee_recurring saja. Setelah dicek, app
   ini SUDAH PUNYA halaman "Dashboard Finance" (fdbLoad, menu Finance
   & Fee) yang menghitung pendapatan lebih lengkap (fee_recurring +
   fee_otf + approval_isp, dengan filter periode & wilayah). Duplikasi
   itu dihapus — sekarang cukup tombol pintasan ke halaman aslinya.
===================================================================== */
(function(){
  'use strict';
  ...
  function renderHealth(c){
    ...
    el.innerHTML =
      ...
      '<button type="button" onclick="navFin(\'fin-dashboard\',\'dashboard\',null)" style="text-align:left;cursor:pointer;background:var(--bg2);border:1.5px solid var(--border);border-radius:var(--r);padding:12px">' +
        '<div style="width:26px;height:26px;border-radius:8px;background:var(--gng2);display:flex;align-items:center;justify-content:center;margin-bottom:8px"><i class="ti ti-chart-pie" style="font-size:13px;color:var(--green)"></i></div>' +
        '<div style="font-size:12.5px;font-weight:800;color:var(--green);display:flex;align-items:center;gap:3px">Dashboard Finance <i class="ti ti-arrow-right" style="font-size:12px"></i></div>' +
        '<div style="font-size:9.5px;font-weight:700;color:var(--text3);text-transform:uppercase;letter-spacing:.4px;margin-top:4px">Lihat Pendapatan</div>' +
      '</button>';
  }
